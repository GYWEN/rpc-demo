...
public class NacosDiscoveryProperties {
	...
	/**
	 * the domain name of a service, through which the server address can be
	...
	/**
	 * if you just want to subscribe, but don't want to register your service,
	 * set it to false.
	 */
	private boolean registerEnabled = true;

	/**
	 * The ip address your want to register for your service instance, needn't
	 * to set it if the auto detect ip works well.
	 */
	private String ip;
	...
	/**
	 * The port your want to register for your service instance, needn't to set
	 * it if the auto detect port works well
	 */
	private int port = -1;
	...
	public String toString() {
		return "NacosDiscoveryProperties{" + "serverAddr='" + serverAddr + '\'' + ", endpoint='" + endpoint + '\''
				...
				+ ", namingLoadCacheAtStart='" + namingLoadCacheAtStart + '\'' + ", metadata=" + metadata + ", registerEnabled="
				+ registerEnabled + ", ip='" + ip + '\'' + ", networkInterface='" + networkInterface + '\'' + ", port=" + port
				+ ", secure=" + secure + ", accessKey='" + accessKey + '\'' + ", secretKey='" + secretKey + '\'' + '}';
	}
