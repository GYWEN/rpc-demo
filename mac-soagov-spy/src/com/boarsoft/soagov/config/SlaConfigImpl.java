...
public class SlaConfigImpl implements SlaConfig {
	...
	public boolean equals(Object o) {
		if (o != null && o instanceof SlaConfigImpl) {
			SlaConfig c = (SlaConfig) o;
	...
	public SlaConfigImpl() {
	}

	public SlaConfigImpl(String key) {
		this.setKey(key);
	}
